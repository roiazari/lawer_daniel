...
const testimonials = [
  ...
  {
    name: "דוד ביטון",
    quote: "צוות המשרד ליווה אותי במסירות ובמקצועיות לאורך כל הדרך. הרגשתי שיש לי על מי לסמוך. תודה רבה!",
    stars: 5,
  },
  {
    name: "רבקה אזולאי",
    quote: "קיבלתי שירות יוצא מן הכלל. ההסברים היו ברורים והטיפול היה מהיר ויעיל. ממליצה בחום!",
    stars: 5,
  },
  {
    name: "שמואל מזרחי",
    quote: "עורכי דין מקצועיים שיודעים את העבודה. הם השיגו עבורי תוצאה טובה יותר ממה שציפיתי.",
    stars: 5,
  },
  {
    name: "תמר חדד",
    quote: "היחס האישי והזמינות של עו'ד לוי היו מעל ומעבר. הרגשתי שמטפלים בי בצורה הטובה ביותר.",
    stars: 5,
  },
];
